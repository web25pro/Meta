...
/** Nav entries, with hrefs relative to wherever the shell is mounted. */
const nav = [
...
export interface AdminShellProps {
  ...
  /**
   * Route prefix the admin panel is mounted under.
   * `'/admin'` inside apps/web, `''` for the standalone apps/admin deployment.
   */
  basePath?: string;
  /** Where "Back to app" points. Hidden when null (standalone admin has no user app to return to). */
    ...
    <div className="min-h-screen bg-bg-surface">
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-white/10 px-lg">
          <Link href={rootHref} className="flex items-center gap-sm">
